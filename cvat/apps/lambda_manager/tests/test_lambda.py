...
class LambdaTestCases(_LambdaTestCaseBase):
    ...
    def _create_interactor_mapping_task(self):
        ...
        return self._create_task(task_spec, self._generate_task_images(1), owner=self.owner)
    ...
    def test_api_v2_lambda_functions_create_interactor_with_extra_params(self):
        ...
        task = self._create_task(task_spec, self._generate_task_images(1), owner=self.owner)
